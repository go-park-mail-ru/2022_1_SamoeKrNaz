...
func initRouter() (*gin.Engine, error) {
	...
	mainRoutes := router.Group(routes.HomeRoute)
	{
		boardRoutes := router.Group(routes.BoardRoute)
		{
			...
			boardRoutes.POST("/:id/:idU", authMiddleware.CheckAuth, boardHandler.AppendUserToBoard, authMiddleware.SendToWebSocket)
			boardRoutes.DELETE("/:id/:idU", authMiddleware.CheckAuth, boardHandler.DeleteUserToBoard, authMiddleware.SendToWebSocket)
			...
			boardRoutes.POST("/append/:link", authMiddleware.CheckAuth, boardHandler.AppendUserToBoardByLink, authMiddleware.SendToWebSocket)
		}
		...
		taskRoutes := router.Group(routes.TaskRoute)
		{
			...
			taskRoutes.DELETE("/:id/:idU", authMiddleware.CheckAuth, taskHandler.DeleteUserFromTask, authMiddleware.SendToWebSocket)
